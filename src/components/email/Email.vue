        ...
        <el-row :gutter="12" style="padding-top: 2.5%;">
          <el-col :span="12">
            <el-card shadow="always">
              <el-descriptions title="Filter Email by Date Range">
                <div>
              ...
              <el-descriptions title="Filter by Email">
                <div>
              ...
              <el-descriptions title="Filter Email by Message body">
                <div>
          ...
          <el-col :span="12">
            <el-card shadow="always">
              <div style="padding-top: 2.5%; padding-bottom: 5%" class="col">
                <el-row>
                  <el-button @click="drawer = true" style="width: 100%" type="primary" round>CREATE SMS</el-button>
                </el-row>
              </div>
              <el-empty :image-size="300" v-if="smsData.length === 0"></el-empty>
              ...
              <el-drawer v-model="drawer" title="I am the title" :with-header="false">
                <div style="text-align: center; font-size: 20px; padding-bottom: 5%">
                  <label class="text-color">Create SMS</label>
                </div>
